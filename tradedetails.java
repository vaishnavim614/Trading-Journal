 ...
 //   String trade_date1 = sdf.format(date1.getDate());
   //  String trade_date2 = sdf.format(date2.getDate()); 
    ...
    if(d1.equals("")  || d2.equals("")){
       pst = con.prepareStatement("select * from add_trade");
      
    }
    else{
        
      pst = con.prepareStatement("select * from add_trade where trade_date between ? and ?");
      pst.setString(1, d1);
      pst.setString(2, d2);
    }
...
*/
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\princy\\Desktop\\Brighton\\pic2\\user (1).png")); // NOI18N
